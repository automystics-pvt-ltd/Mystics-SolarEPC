...
// PORT is only required for the dev/preview server — vite build doesn't need it.
...
// BASE_PATH defaults to '/' for standalone VPS deployments.
...
export default defineConfig({
  ...
  plugins: [
    react(),
    tailwindcss(),
    // Replit-specific plugins: only active inside the Replit workspace
